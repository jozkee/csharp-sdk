...
public static class McpClientExtensions
{
    ...
    /// <summary>
    /// Creates a sampling handler for use with <see cref="McpClientOptions.SamplingHandler"/> that will
    ...
    /// <returns>The created handler delegate that can be assigned to <see cref="McpClientOptions.SamplingHandler"/>.</returns>
    /// <remarks>
    /// <para>

...
internal sealed class McpServer : McpEndpoint, IMcpServer
{
    ...
    {
        // is it ok to return or does it always advertise it?
    ...
    {
        // How to signal that this is not needed?  
        // we don't want to advertise resources if not really supported.

        //if (options.Capabilities?.Resources is not { } options)
        //{
        //    return;
        //}
